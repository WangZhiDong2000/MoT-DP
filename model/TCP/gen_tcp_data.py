...
def gen_sub_folder(seq_data_list):
	...
	if TRAIN:
		file_path = "/home/wang/projects/Bench2DriveZoo/tcp_bench2drive-train"
	else:
		file_path = "/home/wang/projects/Bench2DriveZoo/tcp_bench2drive-val"
...
def get_folder_path(folder_paths, total):
	path = '/home/wang/projects/Bench2DriveZoo/Bench2Drive-mini'
