...
Isolated from the original Transfuser codebase for feature extraction.
"""
...
# Add Transfuser team_code to path for imports
_transfuser_path = os.path.join(os.path.dirname(os.path.dirname(os.path.abspath(__file__))), 
                                 'Transfuser', 'team_code')
if _transfuser_path not in sys.path:
    sys.path.insert(0, _transfuser_path)
