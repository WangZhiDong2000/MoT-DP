...
from timm.models.helpers import load_pretrained, load_custom_pretrained, adapt_model_from_file
...
default_cfgs = {
    ...
    "seresnet18": _cfg(url="", interpolation="bicubic"),
    "seresnet34": _cfg(url="", interpolation="bicubic"),
    "seresnet50": _cfg(
        url="https://github.com/rwightman/pytorch-image-models/releases/download/v0.1-weights/seresnet50_ra_224-8efdb4bb.pth",
        interpolation="bicubic",
    ),
    "seresnet50t": _cfg(url="", interpolation="bicubic", first_conv="conv1.0"),
    "seresnet101": _cfg(url="", interpolation="bicubic"),
    "seresnet152": _cfg(url="", interpolation="bicubic"),
    "seresnet152d": _cfg(
    ...
    "seresnext101_32x4d": _cfg(url="", interpolation="bicubic"),
    "seresnext101_32x8d": _cfg(url="", interpolation="bicubic"),
    "senet154": _cfg(url="", interpolation="bicubic", first_conv="conv1.0"),
    ...
    "ecaresnext26t_32x4d": _cfg(url="", interpolation="bicubic", first_conv="conv1.0"),
    "ecaresnext50t_32x4d": _cfg(url="", interpolation="bicubic", first_conv="conv1.0"),
...
def ig_resnext101_32x16d(pretrained=True, **kwargs):
    ...
    """
    model_args = dict(
        block=Bottleneck, layers=[3, 4, 23, 3], cardinality=32, base_width=16, **kwargs
    )
...
def ig_resnext101_32x32d(pretrained=True, **kwargs):
    ...
    """
    model_args = dict(
        block=Bottleneck, layers=[3, 4, 23, 3], cardinality=32, base_width=32, **kwargs
    )
...
def ig_resnext101_32x48d(pretrained=True, **kwargs):
    ...
    """
    model_args = dict(
        block=Bottleneck, layers=[3, 4, 23, 3], cardinality=32, base_width=48, **kwargs
    )
...
def resnetblur18(pretrained=False, **kwargs):
    ...
    model_args = dict(
        block=BasicBlock, layers=[2, 2, 2, 2], aa_layer=BlurPool2d, **kwargs
    )
...
def resnetblur50(pretrained=False, **kwargs):
    ...
    model_args = dict(
        block=Bottleneck, layers=[3, 4, 6, 3], aa_layer=BlurPool2d, **kwargs
    )
