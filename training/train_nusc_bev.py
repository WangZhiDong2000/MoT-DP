...
def train_nusc_policy(config_path):
    """
    Multi-GPU distributed training for nuScenes driving policy
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Train nuScenes Driving Policy with Diffusion DiT - Multi-GPU Distributed Training")
