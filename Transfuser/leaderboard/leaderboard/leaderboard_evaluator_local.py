...
"""
Ecd /home/wang/Project/carla_garage
conda activate robodiff
export CARLA_ROOT=/home/wang/Project/carla
...
def main():
    ...
    # simulation setup
    parser.add_argument('--routes',  default='/home/wang/Project/carla_garage/leaderboard/data/debug.xml',
    ...
    parser.add_argument("-a", "--agent", type=str, default='/home/wang/Project/carla_garage/team_code/sensor_agent.py',
                        help="Path to Agent's py file to evaluate")
    parser.add_argument("--agent-config", type=str,default='/home/wang/Project/carla_garage/leaderboard/leaderboard/pretrained_models/all_towns',
