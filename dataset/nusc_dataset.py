...
class NUSCDataset(torch.utils.data.Dataset):
    ...
    def __getitem__(self, idx):
        ...
        # action_stats: min=[-0.019322488456964493, -1.1484386920928955], max=[45.14558029174805, 7.632166385650635]
        # waypoint_min = torch.tensor([-2.024, -11.107], dtype=torch.float32)
        # waypoint_max = torch.tensor([55.8288, 13.316], dtype=torch.float32)
